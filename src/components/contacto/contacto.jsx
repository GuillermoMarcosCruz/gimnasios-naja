      ...
      <div className="max-w-6xl mx-auto space-y-16">
        ...
        <div className="text-center space-y-3">
          ...
          <p className="text-sm text-slate-400 max-w-md mx-auto font-medium">
            ¿Tienes dudas sobre las inscripciones o mensualidades? Envíanos un mensaje o visítanos directamente en nuestro dojang.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          <div className="lg:col-span-7 flex flex-col space-y-6">
            ...
            <div className="bg-slate-900 border border-slate-800 p-6 rounded-xl grid grid-cols-1 sm:grid-cols-3 gap-6 shadow-xl">
              ...
              <div className="flex items-center space-x-3">
                ...
                <p className="text-xs text-slate-400 font-medium">Lunes a Viernes (Horarios de tarde)</p>
              </div>
            </div>
          ...
          <div className="lg:col-span-5 bg-slate-900 border border-slate-800 p-2 rounded-xl shadow-xl min-h-[380px] lg:min-h-full overflow-hidden flex flex-col justify-between">
            <iframe
              title="Mapa de ubicación oficial de Gimnasios Naja en Tuxpan"
              src="https://google.com"
              className="w-full h-full min-h-[340px] rounded-lg border-0 invert-[90%] hue-rotate-180 contrast-125 opacity-85 hover:opacity-100 transition-opacity duration-300"
              allowFullScreen=""
              loading="lazy"
