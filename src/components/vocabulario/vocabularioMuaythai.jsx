...
const VOCABULARY = [
  ...
  { seccion: 'numeros', termino: 'JED', significado: 'Número 7', cat: 'Básico', fonetica: 'เจ็ด' },
  { seccion: 'numeros', termino: 'BAED', significado: 'Número 8', cat: 'Básico', fonetica: 'แปด' },
  { seccion: 'numeros', termino: 'GKAO', significado: 'Número 9', cat: 'Básico', fonetica: 'เก้า' },
  { seccion: 'numeros', termino: 'SIB', significado: 'Número 10', cat: 'Básico', fonetica: 'สิบ' },
